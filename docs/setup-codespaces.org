...
#+OPTIONS: tags:nil
#+TITLE: Urban AI
#+SUBTITLE: The browser lane: GitHub Codespaces
#+AUTHOR: Jürgen Hackl
...
- *Your coding agent will not sign in here*: known and expected in the browser lane. See [[file:agent-antigravity.org]] for what to do instead. You will not be stuck in class.
