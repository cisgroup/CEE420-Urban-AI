...
* Signing in is all you need
Sign in with your *Princeton Google account*, the one behind your @princeton.edu address. It works, and it is the account to use.
...
3. Sign in with your Princeton Google account, then come back to VS Code.
...
- *Sign-in will not complete*: try once more in a browser where you are already signed in to your Princeton account. If it still refuses, a personal Google account works too, and either is fine for this course.
